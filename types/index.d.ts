...
declare type ToolbarContainer = string | HTMLElement;
declare type ToolbarOptions = string[] | Record<string, any>[] | (string | Record<string, any>)[];

declare interface ToolbarOptionsObj {
...
declare interface QuillOptionsModules {
  toolbar?: ToolbarOptions | ToolbarOptionsObj;
  [key: string]: any;
}

declare class Module<T = Quill, U = any> {
  static DEFAULTS: any;

  constructor(quill: T, options: U);
}

declare interface Module<T, U = any> {
  quill: T;
  options: U;
}

declare class Embed extends Parchment["Embed"] {
...
declare class Toolbar<T = Quill> extends Module<T, ToolbarOptions> {
...
declare class Clipboard<T> extends Module<T> implements ClipboardStatic {
  container: HTMLElement;
...
declare class Emitter extends EventEmitter.EventEmitter {
  static events: {
...
declare class BaseTheme<T, U> extends Theme<T, U> {
...
declare class SnowTheme<T, U = any> extends BaseTheme<T, U> {
